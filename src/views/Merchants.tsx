  ...
  return (
    <main className="w-full pt-20  bg-gradient-to-b text-white overflow-hidden">
      ...
      <section className="py-20 px-6  md:px-16 lg:px-24 xl:px-40">
        ...
        <p className="text-base md:text-xl text-start max-w-2xl mx-auto leading-relaxed mb-30">
        ...
        <div className="mt-16 text-base md:text-xl max-w-2xl  space-y-4 text-left">
        ...
        <div className="mt-20 text-center">
          <p className="text-[#001A22] font-bold text-2xl md:text-4xl mb-6">
            Built by people
            <br />
            who’ve been there.
          </p>
